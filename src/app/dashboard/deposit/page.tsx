...
const cryptocurrencies = [
  { value: 'BTC', label: 'Bitcoin', icon: <Bitcoin className="h-5 w-5" />, address: 'bc1qv478aj4wfrmygk9fksns3n5kpqesnzype2x0mm', qr: 'https://placehold.co/150x150.png?text=BTC+QR', dataAiHint: "QR code Bitcoin" },
